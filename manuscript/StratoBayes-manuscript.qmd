...
The StratoBayes R package can be installed from binaries by following the instructions at https://stratobayes.github.io. The data and code used to generate the results, and copies of the software binaries, are available at https://github.com/StratoBayes/StratoBayes-Manuscript and the linked Zenodo archive https://zenodo.org/records/15064824.
